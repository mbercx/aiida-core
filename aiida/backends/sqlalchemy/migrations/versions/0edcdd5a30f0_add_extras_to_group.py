...
def upgrade():
    ...
    op.add_column(
        'db_dbgroup', sa.Column('extras', postgresql.JSONB(astext_type=sa.Text()), server_default='{}', nullable=True)
    )
    op.alter_column('db_dbnode', 'extras', server_default='{}')
    op.alter_column('db_dbnode', 'attributes', server_default='{}')
...
def downgrade():
    ...
    op.alter_column('db_dbnode', 'extras', server_default=None)
    op.alter_column('db_dbnode', 'attributes', server_default=None)
